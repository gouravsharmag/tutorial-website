...
<head>
    ...
    <title><?php echo $content[0]['topic_name'];?></title>
...
<body>
    ...
    <span style="float:left;padding-top:2px;"><a href="../" style="color:#000000;text-decoration:none;padding-left: 1.5rem;"><span style="background:#0fc6b0;padding: 3px 6px;border-radius: 50%;">A</span>pnaTutorial</a></span> 
